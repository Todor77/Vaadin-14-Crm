package com.vaadin.tutorial.com.backend.service;

import com.vaadin.tutorial.com.backend.entity.Company;
import com.vaadin.tutorial.com.backend.entity.Contact;
import com.vaadin.tutorial.com.backend.repository.CompanyRepository;
import com.vaadin.tutorial.com.backend.repository.ContactRepository;
			...
			contactRepository.saveAll(
					Stream.of("Gabrielle Patel", "Brian Robinson", "Eduardo Haugen",
							...
							.map(name -> {
								...
								String email = (contact.getFirstName() + "." + contact.getLastName() + "@" + contact.getCompany().getName().replaceAll("[\\s-]", ""));
